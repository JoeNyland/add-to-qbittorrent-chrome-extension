...
2. If a site copies a torrent link to your clipboard, you can also click the extension icon and select "Add Link from Clipboard" to add the torrent link from your clipboard.
